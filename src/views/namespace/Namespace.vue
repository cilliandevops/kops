                        ...
                        v-loading="appLoading">
                            ...
                            <el-table-column align=center label="操作" min-width="120">
                                <template v-slot="scope">
                                    ...
                                    <el-button size="small" style="border-radius:2px;" icon="Delete" type="danger" plain @click="handleConfirm(scope, '删除', delNamespace)">删除</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                        <el-pagination
...
export default {
    ...
    methods: {
        ...
        updateNamespace() {
            let content = JSON.stringify(this.namespaceDetail)
