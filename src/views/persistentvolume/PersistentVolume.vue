<template>
  <div class="pv">
        ...
        <div>
          <el-card class="pv-head-card" shadow="never" :body-style="{ padding: '10px' }">
            <el-row>
              ...
              <el-col :span="6">
                <div>
                  <el-input class="pv-head-search" clearable placeholder="请输入" v-model="searchInput" />
                  <el-button style="border-radius: 2px" icon="Search" type="primary" plain @click="getPvs()"
                    >搜索</el-button
                  >
                </div>
              </el-col>
      ...
      <el-col :span="24">
        <div>
          <el-card class="pv-body-card" shadow="never" :body-style="{ padding: '5px' }">
            <el-table style="width: 100%; font-size: 12px; margin-bottom: 10px" :data="pvList" v-loading="appLoading">
              ...
              <el-table-column align="center" prop="spec.accessModes[0]" label="访问模式" />
              <el-table-column align="center" prop="spec.capacity.storage" label="容量" />
              <el-table-column align="center" prop="spec.claimRef.name" label="PVC" />
              ...
              <el-table-column align="center" label="操作" min-width="120">
                <template v-slot="scope">
                  ...
                  <el-button
                    ...
                    icon="Delete"
                    type="danger"
                    @click="handleConfirm(scope, '删除', delPv)"
                    >删除</el-button
                  >
                </template>
              </el-table-column>
    ...
    <el-dialog title="YAML信息" v-model="yamlDialog" width="45%" top="5%">
      <JsonEditorVue style="height: 500px" v-model="pvDetail" :showBtns="false" :mode="'code'" lang="zh" />
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="yamlDialog = false">取 消</el-button>
          <el-button type="primary" @click="updatePv()">更 新</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    specTrans(str) {
      ...
      const num = str.slice(0, -2) / 1024 / 1024
    ...
    getPvs() {
      ...
      httpClient
        .get(this.getPvsData.url, { params: this.getPvsData.params })
        .then((res) => {
    ...
    delPv(e) {
      ...
      httpClient
        .delete(this.delPvData.url, { data: this.delPvData.params })
        .then((res) => {
          this.getPvs()
          this.$message.success({
            message: res.msg
